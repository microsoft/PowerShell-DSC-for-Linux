...
class WorkerManager(object):
    ...
    def get_worker_and_sandbox_processes(process_list):
        ...
        for process in process_list:
            if ("python2" in process.cmd or "python3" in process.cmd) and ("hybridworker.py" in process.cmd or "sandbox.py" in process.cmd) \
    ...
    def get_worker_processes(process_list):
        ...
        worker_processes = []
        for process in process_list:
            if ("python2" in process.cmd or "python3" in process.cmd) and "hybridworker.py" in process.cmd \
                    and "MSFT_nxOMSAutomationWorkerResource" in process.cmd:

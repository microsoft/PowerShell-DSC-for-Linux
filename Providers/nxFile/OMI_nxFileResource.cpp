...
struct _OMI_nxFileResource_Self
{
public:
    PyObjPtr pModule;
    PyObjPtr pSetFn;
    ...
    static int create (_OMI_nxFileResource_Self** const ppInstance);

private:
    /*ctor*/ _OMI_nxFileResource_Self (
...
typedef _OMI_nxFileResource_Self OMI_nxFileResource_Self;



/*static*/
int
_OMI_nxFileResource_Self::create (
    _OMI_nxFileResource_Self** const ppInstance)
{
    ...
    if (ppInstance &&
        !*ppInstance)
    {
        if (EXIT_SUCCESS == (rval = initPython ("do'h", "/home/johnkord/dev/sandbox/dsc_providers/nxFile")))
        {
            ...
            if (pModule)
            {
                ...
                {
                    *ppInstance = new _OMI_nxFileResource_Self (
...
void MI_CALL OMI_nxFileResource_Load(
    ...
    _In_ MI_Context* context)
{
    ...
    if (EXIT_SUCCESS != OMI_nxFileResource_Self::create (self))
    {
...
void MI_CALL OMI_nxFileResource_Unload(
...
void MI_CALL OMI_nxFileResource_EnumerateInstances(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL OMI_nxFileResource_GetInstance(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL OMI_nxFileResource_CreateInstance(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL OMI_nxFileResource_ModifyInstance(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL OMI_nxFileResource_DeleteInstance(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL OMI_nxFileResource_Invoke_GetTargetResource(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const OMI_nxFileResource_GetTargetResource* in)
{
    ...
    OMI_nxFileResource_GetTargetResource out;
    MI_Instance *newInstance;
    MI_Value value;

    r = OMI_nxFileResource_GetTargetResource_Construct(&out, context);
    r = OMI_nxFileResource_GetTargetResource_Set_MIReturn(&out, 0);

    const OMI_nxFileResource * file = in->InputResource.value;
    ...
    r = OMI_nxFileResource_GetTargetResource_Post(&out, context);
    if ( r != MI_RESULT_OK )
    {
        MI_Context_PostResult(context, r);
        return;
    ...
    r = OMI_nxFileResource_GetTargetResource_Destruct(&out);
    if ( r != MI_RESULT_OK )
    {
        MI_Context_PostResult(context, r);
        return;
...
void MI_CALL OMI_nxFileResource_Invoke_TestTargetResource(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const OMI_nxFileResource_TestTargetResource* in)
{
    ...
    MI_Result r = MI_RESULT_OK;
    MI_Boolean res = MI_TRUE;
    OMI_nxFileResource_TestTargetResource out;
    const OMI_nxFileResource * file = in->InputResource.value;
    ...
    r = OMI_nxFileResource_TestTargetResource_Construct(&out, context);
    r = OMI_nxFileResource_TestTargetResource_Set_Result(&out, res);
    r = OMI_nxFileResource_TestTargetResource_Set_MIReturn(&out, 0);
    r = OMI_nxFileResource_TestTargetResource_Post(&out, context);
    r = OMI_nxFileResource_TestTargetResource_Destruct(&out);
    MI_Context_PostResult(context, MI_RESULT_OK);
}

void MI_CALL OMI_nxFileResource_Invoke_SetTargetResource(
    _In_opt_ OMI_nxFileResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const OMI_nxFileResource_SetTargetResource* in)
{
    ...
    MI_Result r = MI_RESULT_OK;
    OMI_nxFileResource_SetTargetResource out;
    const OMI_nxFileResource * file = in->InputResource.value;
    MI_Result res = MI_RESULT_OK;
    ...
    r = OMI_nxFileResource_SetTargetResource_Construct(&out, context);
    r = OMI_nxFileResource_SetTargetResource_Set_MIReturn(&out, res);
    r = OMI_nxFileResource_SetTargetResource_Post(&out, context);
    r = OMI_nxFileResource_SetTargetResource_Destruct(&out);
    MI_Context_PostResult(context, res);
}

...
def GetAptUpdates(Name):
    ...
    privileged_path = "/var/opt/microsoft/omsagent" #omsagent omiusers
    #Collect Security updates
    security_sources_list = privileged_path + '/tmp/msft-v1-assess-security-{0}.list'.format(g_guid)
    ...
    remove_security_sources_list_cmd = 'rm ' + privileged_path + '/tmp/msft-v1-assess-security-*.list'

...
def init_vars(Ensure, CustomLogObjects):
...
def Set_Marshall(Name, Ensure, EnableCustomLogConfiguration = False, CustomLogObjects = None):
    init_vars(Ensure, CustomLogObjects)
    Set(EnableCustomLogConfiguration, Ensure, CustomLogObjects)
    return [0] 

def Test_Marshall(Name, Ensure, EnableCustomLogConfiguration = False, CustomLogObjects = None):
    init_vars(Ensure, CustomLogObjects)
    return Test(EnableCustomLogConfiguration, Ensure, CustomLogObjects)

def Get_Marshall(Name, Ensure, EnableCustomLogConfiguration = False, CustomLogObjects = None):

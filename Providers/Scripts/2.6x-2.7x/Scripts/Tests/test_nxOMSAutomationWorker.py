...
if __name__ == '__main__':
    test_suite1 = unittest2.TestLoader().loadTestsFromTestCase(nxOMSAutomationWorkerTestCases)
    unittest2.TextTestRunner(stream=sys.stdout, verbosity=3).run([test_suite1])
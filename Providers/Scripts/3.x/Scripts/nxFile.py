...
def ReadFile(path):
    ...
    with opened_w_error(path, 'r') as (F, error):
        if error:
            ...
            l().Log('ERROR', "Exception opening file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
        else:
            d = F.read()
    return d, error
...
def LStatFile(path):
    ...
    try:
        d=os.lstat(path)
         ...
         l().Log('ERROR', "Exception lstating file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
...
def StatFile(path):
    ...
    try:
        ...
        l().Log('ERROR', "Exception stating file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception stating file " + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception stating file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return d
...
def Chown(path, owner, group):
    ...
    try:
        ...
        l().Log('ERROR', "Exception changing ownership of file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception changing ownership of file " + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception changing ownership of file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def Chmod(path, mode):
    ...
    try:
        ...
        l().Log('ERROR', "Exception  changing mode of file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception  changing mode of file " + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception  changing mode of file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def ListDir(path):
    ...
    try:
        ...
        l().Log('ERROR', "Exception listing dir " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception listing dir" + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception listing dir " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return d
...
def Symlink(spath, dpath):
    ...
    if os.path.exists(dpath):
        try:
            ...
            l().Log('ERROR', "Exception removing " + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
            return error
        except IOError as error:
            print("Exception removing " + dpath + " Error Code: " + str(error.errno) +  " Error Code: " + str(error.errno) + " Error: "  + error.strerror, file=sys.stderr)
            l().Log('ERROR', "Exception removing " + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    ...
    try:
        ...
        l().Log('ERROR', "Exception creating symlink from " + spath + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception creating symlink from " + spath  + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception creating symlink from " + spath + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def MakeDirs(path):
    ...
    try:
        ...
        l().Log('ERROR', "Exception making dir" + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception making dir" + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception making dir" + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def RemoveFile(path):
    ...
    try:
        ...
        l().Log('ERROR', "Exception removing file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception removing file" + path  + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception removing file " + path + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def CopyFile(spath, dpath):
    ...
    try:
        ...
        l().Log('ERROR', "Exception copying tree " + spath + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    except IOError as error:
        print("Exception copying tree " + spath  + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
        l().Log('ERROR', "Exception copying tree " + spath + ' to ' + dpath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
    return error
...
def TestOwnerGroupMode(DestinationPath, SourcePath, fc):
    ...
    if fc.Owner:
        try:
            ...
            l().Log('ERROR', "Exception obtaining gid from group name " + fc.Group + " Error: " + repr(error))
            return False
...
def SetFile(DestinationPath, SourcePath, fc):
    ...
    if SourcePath and len(SourcePath) > 0:
        ...
        try:
            ...
            l().Log('ERROR', "Exception creating file " + DestinationPath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
        except IOError as error:
            print("Exception creating file " + DestinationPath + " Error Code: " + str(error.errno) + " Error: " +error.strerror, file=sys.stderr)
            l().Log('ERROR', "Exception creating file " + DestinationPath + " Error Code: " + str(error.errno) + " Error: " + error.strerror)
        ...
        if Mode:
            if len(Mode) == 9:
                try:
                    ...
                    l().Log('ERROR', "Exception in ConvertLongModeToNumeric on " + Mode + " Error: " + error.strerror)
            elif len(Mode) == 3:

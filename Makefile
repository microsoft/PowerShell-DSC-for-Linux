...
ifeq ($(BUILD_OMS),BUILD_OMS)
dsckit098: nx nxOMSAgent nxOMSPlugin nxOMSCustomLog nxFileInventory nxOMSDummy
else
...
ifeq ($(BUILD_OMS),BUILD_OMS)
dsckit100: nx nxOMSAgent nxOMSPlugin nxOMSCustomLog nxFileInventory nxOMSDummy
else

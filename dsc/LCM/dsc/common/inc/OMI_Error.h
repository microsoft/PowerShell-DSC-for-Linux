...
MI_INLINE MI_Result MI_CALL OMI_Error_Construct(
    _Out_ OMI_Error* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructInstance(context, &OMI_Error_rtti,
...
MI_INLINE MI_Result MI_CALL OMI_Error_Post(
    _In_ const OMI_Error* self,
    _In_ MI_Context* context,

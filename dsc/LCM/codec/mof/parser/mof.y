...
classFeatureList
    : propertyDeclaration
    {
        ...
        $1->flags |= GetQualFlags(state, $1->qualifiers, $1->numQualifiers);
        if (PtrArray_Append(state, (PtrArray*)&$$.propertySet, $1) != 0)
        {
            YYABORT;
        }
    }
    | methodDeclaration
    {
        ...
        $1->flags |= GetQualFlags(state, $1->qualifiers, $1->numQualifiers);
        if (PtrArray_Append(state, (PtrArray*)&$$.methodList, $1) != 0)
        {
            YYABORT;
        }
    }
    ...
    | classFeatureList propertyDeclaration
    {
        ...
        if (PtrArray_Append(state, (PtrArray*)&$$.propertySet, $2) != 0)
        {
            YYABORT;
        }
    }
    | classFeatureList methodDeclaration
    {
        ...
        $2->flags |= GetQualFlags(state, $2->qualifiers, $2->numQualifiers);
        if (PtrArray_Append(state, (PtrArray*)&$$.methodList, $2) != 0)
        {
            YYABORT;
        }
    }
...
qualifierList
    : qualifier
    {
        $$.data = NULL;
        $$.size = 0;
        if (PtrArray_Append(state, (PtrArray*)&$$, $1) != 0)
        {
            YYABORT;
        }
    }
    | qualifierList ',' qualifier
    {
        ...
        if (PtrArray_Append(state, (PtrArray*)&$$, $3) != 0)
        {
            YYABORT;
        }
    }

...
$(TARGET): $(__OBJECTS)
	mkdir -p $(LIBDIR)
	$(CC) -o $(TARGET) $(__OBJECTS) -L$(LIBDIR) $(__LIBRARIES) $(__LIBRARIES) $(CSHLIBFLAGS) $(LIBNAMEOPT)
ifdef DEVBUILD
...
$(TARGET): $(__OBJECTS)
	mkdir -p $(LIBDIR)
	$(CXX) -o $(TARGET) $(__OBJECTS) -L$(LIBDIR) $(__LIBRARIES) $(__LIBRARIES) $(CXXSHLIBFLAGS) $(LIBNAMEOPT)
ifdef DEVBUILD
ifndef SUPPRESS_CHKSHLIB
	$(BINDIR)/chkshlib $(TARGET) || ( rm -rf $(TARGET) && false )
endif
...
$(TARGET): $(__OBJECTS) $(__DEPS)
	mkdir -p $(BINDIR)
	$(CC) -o $(TARGET) $(__OBJECTS) -L$(LIBDIR) $(__LIBRARIES) $(__LIBRARIES) $(CPROGFLAGS)
	@ echo
...
$(TARGET): $(__OBJECTS) $(__DEPS)
	mkdir -p $(BINDIR)
	$(CXX) -o $(TARGET) $(__OBJECTS) -L$(LIBDIR) $(__LIBRARIES) $(__LIBRARIES) $(CXXPROGFLAGS)
	@ echo

...
static void _DispEnumParent_Provider_PostControl( _In_ Strand* self, _In_ Message* msg)
{
    DEBUG_ASSERT( MI_FALSE );  // not used yet
}

static void _DispEnumParent_Provider_Close( _In_ Strand* self )
{
...
static StrandFT _DispEnumParent_ProviderFT = { 
    NULL, 
    _DispEnumParent_Provider_PostControl, 
    NULL, 
    NULL, 
    _DispEnumParent_Provider_Close,
    NULL,
    NULL,
    NULL,
    NULL,

...
/*
Open Instrumentation event declarations for OMI/WinOMI

Helpful tips:
- WinIDE will pull up the format for the event via intellisense if you incase OI macro in C-style comments
...
/* 
    WinOMI/OMI specific data structures

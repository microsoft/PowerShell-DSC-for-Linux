...
void MI_CALL MSFT_FileDirectoryConfiguration_Load(
...
void MI_CALL MSFT_FileDirectoryConfiguration_EnumerateInstances(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL MSFT_FileDirectoryConfiguration_GetInstance(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL MSFT_FileDirectoryConfiguration_DeleteInstance(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL MSFT_FileDirectoryConfiguration_Invoke_GetTargetResource(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const MSFT_FileDirectoryConfiguration_GetTargetResource* in)
{
    ...
    Invoke_GetTargetResource(context, in->InputResource.value);
}

void MI_CALL MSFT_FileDirectoryConfiguration_Invoke_TestTargetResource(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const MSFT_FileDirectoryConfiguration_TestTargetResource* in)
{
    ...
    Invoke_TestTargetResource(context, in->InputResource.value);

}

void MI_CALL MSFT_FileDirectoryConfiguration_Invoke_SetTargetResource(
    _In_opt_ MSFT_FileDirectoryConfiguration_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_opt_ const MSFT_FileDirectoryConfiguration_SetTargetResource* in)
{
    ...
    Invoke_SetTargetResource(context, in->InputResource.value);
}

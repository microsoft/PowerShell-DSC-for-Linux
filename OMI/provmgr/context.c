...
//TODO: Un-comment once Windows is IOCP based
    ...
    const MI_Instance* instance)
{
    ...
    // This is an internal context, doesnt need interaction 
    Context_Init(ctx, self->provider, NULL);    //TODO check Context_Init result
    ...
    MI_Result result)
{
     ...
     * particular provider implements the operation. This is consistent
     * with the behavior in WMI.
     */
    if (result == MI_RESULT_NOT_SUPPORTED)
    {
    ...
    _In_ MI_Boolean subscriptionRefcounted)
{
    ...
    /* TODO: need a global cache to validate the pointer*/

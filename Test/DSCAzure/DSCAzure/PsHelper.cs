...
namespace DSCAzure
{
    ...
    public class PsHelper : IDisposable
    {
        ...
        public string LastPowerShellReturnString
        {
            get;
            set;
        }
        ...
        public void Run(string[] scripts)
        {
            ...
            try
            {
                ...
                LastPowerShellReturnString = ConvertPowerShellObjectsToString(objs);
            }
        ...
        private static string ConvertPowerShellObjectsToString(IEnumerable<PSObject> psObjects)
        {
            if (psObjects == null)
                return null;

...
namespace DSC
{
    class nxFirewallTest : ProviderTestBase
    {
        ...
        public override void Setup(IContext ctx)
        {
            ...
            //set Accesss value
            string access = propMap.ContainsKey("Access") ? propMap["Access"] : string.Empty;
            if (access.ToLower().Equals("allow"))
            {
                propMap["Access"] = "ACCEPT";
            }
            ...
            if (!propMap.ContainsKey("Protocol"))
            {
                propMap["Protocol"] = "tcp";
            }

            if (!propMap.ContainsKey("Position"))
            {
                propMap["Position"] = "top";
            }
        ...
        private string GetInitializeCmd()
        {
            ...
            if (!string.IsNullOrEmpty(initialSet))
            {
                ...
                string initialCmmd = " -A" + direction + protocol + access;
